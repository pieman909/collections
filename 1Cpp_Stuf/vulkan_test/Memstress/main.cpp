...
#include "shader.h" // Will be generated from memory_stress.comp
...
int main() {
    ...
    VkShaderModuleCreateInfo smInfo{}; smInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO; smInfo.codeSize = sizeof(memory_stress_spv); smInfo.pCode = reinterpret_cast<const uint32_t*>(memory_stress_spv);

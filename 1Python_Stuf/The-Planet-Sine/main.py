...
class App:
    def __init__(self, win_size=(1600, 900)):
        ...
        # load shaders
        with open('/home/spurdo_sparde/Documents/1Python_Stuf/The-Planet-Sine/programs/vertex.glsl') as f:
            vertex = f.read()
        with open('/home/spurdo_sparde/Documents/1Python_Stuf/The-Planet-Sine/programs/fragment.glsl') as f:
            fragment = f.read()
